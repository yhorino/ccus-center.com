...
<link rel="stylesheet" href="/ccus-test/wp-content/themes/cocoon-child-master/tmp/header.css" type="text/css">
...
<header id="common_header">
 <div id="ch_header" class="ch_outer ccus <?php echo $option_class;?>">
  <div class="ch_logo">
   <a href="/">
	   <div class="ch_logo_button_pc"><img src="/ccus-test/wp-content/uploads/2023/12/logo_ccus.png" alt="全国建設キャリアアップ登録センター"></div>
	   <div class="ch_logo_button_sp"><img src="/ccus-test/wp-content/uploads/2023/12/logo_ccus.png" alt="全国建設キャリアアップ登録センター"></div>
   </a>
  </div>
  ...
  <div class="ch_tel">
   <a href="tel:0120968631">
    <div class="ch_tel_button_pc"><img src="/ccus-test/wp-content/uploads/2023/12/top_tel_ccus_s.png" alt="0120968631"></div>
...
<?php 
 if($sidemenu_mode == 'mypage'){
  include '/home/rjc/domains/ccus-center.com/public_html/ccus-test/wp-content/themes/cocoon-child-master/tmp/sidemenu_mypage.php';
 } else {
//  include get_stylesheet_directory().'/tmp/sidemenu.php';
  include '/home/rjc/domains/ccus-center.com/public_html/ccus-test/wp-content/themes/cocoon-child-master/tmp/sidemenu.php';
 }
?>
